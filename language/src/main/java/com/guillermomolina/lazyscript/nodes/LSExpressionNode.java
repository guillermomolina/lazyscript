...
@GenerateWrapper
public abstract class LSExpressionNode extends LSStatementNode {
    ...
    /**
     * When we use an expression at places where a {@link LSStatementNode statement} is already
    ...
    public WrapperNode createWrapper(ProbeNode probe) {
        return new LSExpressionNodeWrapper(this, probe);
    }
    ...
    public boolean executeBoolean(VirtualFrame frame) throws UnexpectedResultException {
        return LSTypesGen.expectBoolean(executeGeneric(frame));
    }
}
