 ...
 * the {@link LSWhileNode} and {@link LSWhileRepeatingNode} allows Truffle to perform loop
 * optimizations, for example, compile just the loop body for long running loops.
 */
public final class LSWhileRepeatingNode extends Node implements RepeatingNode {

    /**
     * The condition of the loop. This in a {@link LSExpressionNode} because we require a result
     ...
     */
    @Child private LSExpressionNode conditionNode;

    /** Statement (or {@link LSBlockNode block}) executed as long as the condition is true. */
    ...
    public LSWhileRepeatingNode(LSExpressionNode conditionNode, LSStatementNode bodyNode) {
        this.conditionNode = LSUnboxNodeGen.create(conditionNode);
    ...
    public String toString() {
        return LSStatementNode.formatSourceSection(this);
    }
