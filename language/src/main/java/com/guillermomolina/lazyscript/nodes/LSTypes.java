...
public abstract class LSTypes {
     ...
     * check that the Truffle DLL would generate. For {@link LSNull}, we do not need an
     * {@code instanceof} check, because we know that there is only a {@link LSNull#INSTANCE
     * singleton} instance.
     */
     ...
     * that the Truffle DLL would generate. For {@link LSNull}, we do not need an actual cast,
