...
/**
 * Example of a lazy unary node that uses type specialization. See {@link LSAddNode} for
 * information on specializations.
 */
@NodeChild("valueNode")
@NodeInfo(shortName = "!")
public abstract class LSLogicalNotNode extends LSExpressionNode {
    ...
    protected Object typeError(Object value) {
        throw LSException.typeError(this, value);
    }
