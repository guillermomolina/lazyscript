...
public final class LSWhileNode extends LSStatementNode {
    ...
    public LSWhileNode(LSExpressionNode conditionNode, LSStatementNode bodyNode) {
        this.loopNode = Truffle.getRuntime().createLoopNode(new LSWhileRepeatingNode(conditionNode, bodyNode));
    }
