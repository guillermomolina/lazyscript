...
public final class LSIfNode extends LSStatementNode {
    ...
    /**
     * The condition of the {@code if}. This in a {@link LSExpressionNode} because we require a
    ...
    /** Statement (or {@link LSBlockNode block}) executed when the condition is true. */
    @Child private LSStatementNode thenPartNode;

    /** Statement (or {@link LSBlockNode block}) executed when the condition is false. */
    @Child private LSStatementNode elsePartNode;
    ...
    public LSIfNode(LSExpressionNode conditionNode, LSStatementNode thenPartNode, LSStatementNode elsePartNode) {
