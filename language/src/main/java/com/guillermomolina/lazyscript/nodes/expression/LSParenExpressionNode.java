...
public class LSParenExpressionNode extends LSExpressionNode {

    @Child private LSExpressionNode expression;

    public LSParenExpressionNode(LSExpressionNode expression) {
