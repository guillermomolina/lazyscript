/*
 * Copyright (c) 2016, 2018, Guillermo Adrián Molina. All rights reserved.
...
/**
 * Logical operations in LazyScript use short circuit evaluation: if the evaluation of the left operand
 * already decides the result of the operation, the right operand must not be executed. This is
 * expressed in using this base class for {@link LSLogicalAndNode} and {@link LSLogicalOrNode}.
 */
public abstract class LSShortCircuitNode extends LSExpressionNode {

    @Child private LSExpressionNode left;
    @Child private LSExpressionNode right;
    ...
    public LSShortCircuitNode(LSExpressionNode left, LSExpressionNode right) {
        this.left = left;
        this.right = right;
    }
    ...
    public final boolean executeBoolean(VirtualFrame frame) {
        ...
        try {
            ...
            throw LSException.typeError(this, e.getResult(), null);
        }
        boolean rightValue;
        try {
            ...
            throw LSException.typeError(this, leftValue, e.getResult());
        }
