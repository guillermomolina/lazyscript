/*
 * Copyright (c) 2015, 2019, Guillermo Adrián Molina. All rights reserved.
 ...
 * SOFTWARE.
 */
package com.guillermomolina.lazyscript.nodes.util;
...
@NodeChild
public abstract class LSUnboxNode extends LSExpressionNode {
    ...
    @Specialization
    protected static LSFunction fromFunction(LSFunction value) {
        return value;
    }

    @Specialization
    protected static LSNull fromFunction(LSNull value) {
        return value;
    }
