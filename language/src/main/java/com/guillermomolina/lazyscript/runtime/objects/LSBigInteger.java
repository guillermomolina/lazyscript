...
public final class LSBigInteger extends LSObject implements Comparable<LSBigInteger> {
    ...
    public LSBigInteger(BigInteger value) {
        this.value = value;
    }

    public LSBigInteger(long value) {
    ...
    @TruffleBoundary
    public int compareTo(LSBigInteger o) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof LSBigInteger) {
            return value.equals(((LSBigInteger) obj).getValue());
        }
        return false;
    }
