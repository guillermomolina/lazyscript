...
public final class LSFunction extends LSObject {
    ...
    static final class IsIdenticalOrUndefined {
        ...
        static TriState doLLFunction(LSFunction receiver, LSFunction other) {
            /*
             * LSFunctions are potentially identical to other LSFunctions.
             */
            return receiver == other ? TriState.TRUE : TriState.FALSE;
        }

        @Fallback
        static TriState doOther(LSFunction receiver, Object other) {
    ...
    @ExportMessage
    @TruffleBoundary
    static int identityHashCode(LSFunction receiver) {
    ...
    abstract static class Execute {
         ...
         * function is redefined, the call target maintained by the LSFunction object is changed. To
         * avoid a check for that, we use an Assumption that is invalidated by the LSFunction when
        ...
        protected static Object doDirect(LSFunction function, Object[] arguments,
