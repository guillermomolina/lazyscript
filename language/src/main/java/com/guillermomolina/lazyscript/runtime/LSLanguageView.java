 ...
 * calls routines to print such values the LazyScript way. It is important to note that language
...
public final class LSLanguageView implements TruffleObject {

    final Object delegate;

    LSLanguageView(Object delegate) {
    ...
    boolean hasMetaObject(@CachedLibrary("this.delegate") InteropLibrary interop) {
        /*
         * We use the isInstance method to find out whether one of the builtin lazy language types
    ...
    public static Object create(Object value) {
        ...
        return new LSLanguageView(value);
    }
     ...
     * that are already originating from LazyScript. This is useful to view values from the
     * perspective of lazy language in slow paths, for example, printing values in error messages.
     */
    @TruffleBoundary
