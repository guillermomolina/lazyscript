...
public final class LLInvokeFunctionNode extends LLExpressionNode {

    @Child
    private LLExpressionNode functionNode;
    @Children
    private final LLExpressionNode[] argumentNodes;
    @Child
    private InteropLibrary library;

    public LLInvokeFunctionNode(LLExpressionNode functionNode, LLExpressionNode[] argumentNodes) {
    ...
    public Object executeGeneric(VirtualFrame frame) {
        ...
        try {
            ...
            throw LLUndefinedNameException.undefinedFunction(this, "unnamed");
        }
    }
