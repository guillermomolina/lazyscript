...
@NodeInfo(shortName = "[]")
public final class LLArrayLiteralNode extends LLExpressionNode {
    ...
    public LLArrayLiteralNode(LLExpressionNode[] argumentNodes) {
    ...
    public Object executeGeneric(VirtualFrame frame) {
        ...
        LLObject array = lookupContextReference(LazyLanguage.class).get().createObject();
        for (int i = 0; i < argumentNodes.length; i++) {
