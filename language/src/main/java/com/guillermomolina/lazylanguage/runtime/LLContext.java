 ...
 * {@link LazyLanguage}. It is used, for example, by
 * {@link LLBuiltinNode#getContext() builtin functions}.
 * <p>
...
public final class LLContext {
    ...
    private static final Source BUILTIN_SOURCE = Source.newBuilder(LazyLanguage.ID, "", "Lazy builtin").build();
    ...
    /**
     * Returns the default input, i.e., the source for the {@link LLReadlnBuiltin}.
    ...
    /**
     * The default default, i.e., the output for the {@link LLPrintlnBuiltin}. To
    ...
    /**
     * Adds all builtin functions to the {@link LLFunctionRegistry}. This method
     * lists all {@link LLBuiltinNode builtin implementation classes}.
     */
    ...
    public void installBuiltin(NodeFactory<? extends LLBuiltinNode> factory) {
         ...
         * in as an Object[] array encapsulated in LLArguments. A LLReadArgumentNode
    ...
    public Object getFunction(Object obj, String name) throws UnknownIdentifierException {
        ...
        return LLObjectUtil.getFunction(object, name);
    }
    ...
    public static LLContext getCurrent() {
        return LazyLanguage.getCurrentContext();
    }
