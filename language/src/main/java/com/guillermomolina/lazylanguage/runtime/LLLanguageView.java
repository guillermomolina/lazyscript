 ...
 * calls routines to print such values the LazyLanguage way. It is important to note that language
...
public final class LLLanguageView implements TruffleObject {
     ...
     * that are already originating from LazyLanguage. This is useful to view values from the
