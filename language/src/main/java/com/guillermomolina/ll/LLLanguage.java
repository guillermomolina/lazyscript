 ...
 * SOFTWARE.
 */
package com.guillermomolina.ll;
...
import com.guillermomolina.ll.builtins.LLNanoTimeBuiltin;
import com.guillermomolina.ll.builtins.LLPrintlnBuiltin;
import com.guillermomolina.ll.builtins.LLReadlnBuiltin;
import com.guillermomolina.ll.builtins.LLStackTraceBuiltin;
import com.guillermomolina.ll.nodes.LLEvalRootNode;
import com.guillermomolina.ll.nodes.LLTypes;
...
import com.guillermomolina.ll.nodes.expression.LLAddNode;
import com.guillermomolina.ll.nodes.expression.LLBigIntegerLiteralNode;
import com.guillermomolina.ll.nodes.expression.LLDivNode;
import com.guillermomolina.ll.nodes.expression.LLEqualNode;
...
import com.guillermomolina.ll.nodes.expression.LLLessOrEqualNode;
import com.guillermomolina.ll.nodes.expression.LLLessThanNode;
...
import com.guillermomolina.ll.nodes.expression.LLMulNode;
...
import com.guillermomolina.ll.nodes.expression.LLSubNode;
import com.guillermomolina.ll.nodes.expression.LLWritePropertyNode;
import com.guillermomolina.ll.nodes.local.LLLexicalScope;
...
import com.guillermomolina.ll.runtime.LLFunction;
import com.guillermomolina.ll.runtime.LLFunctionRegistry;
import com.guillermomolina.ll.runtime.LLLanguageView;
import com.guillermomolina.ll.runtime.LLNull;
import com.guillermomolina.ll.runtime.LLObject;
...
/**
 * LL is a lazy language to demonstrate and showcase features of Truffle. The implementation is as
 ...
 * <p>
 * LL is dynamically typed, i.e., there are no type names specified by the programmer. LL is
 ...
 * the LL source are added to the {@link LLFunctionRegistry}, which is accessible from the
 * {@link LLContext}.
 *
 * <p>
 * <b>Builtin functions:</b><br>
 * Library functions that are available to every LL source without prior definition are called
 ...
 * </ul>
 */
@TruffleLanguage.Registration(id = LLLanguage.ID, name = "LL", defaultMimeType = LLLanguage.MIME_TYPE, characterMimeTypes = LLLanguage.MIME_TYPE, contextPolicy = ContextPolicy.SHARED, fileTypeDetectors = LLFileDetector.class)
