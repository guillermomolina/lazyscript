// Generated from language/src/main/java/com/guillermomolina/ll/parser/LazyLanguage.g4 by ANTLR 4.7.1
...
public class LazyLanguageParser extends Parser {
	...
	public static final int
		RULE_lazylanguage = 0, RULE_function = 1, RULE_block = 2, RULE_statement = 3, 
	...
	public static final String[] ruleNames = {
		"lazylanguage", "function", "block", "statement", "while_statement", "if_statement", 
	...
	@Override
	public String getGrammarFileName() { return "LazyLanguage.g4"; }
	...
	public LazyLanguageParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}
	public static class LazylanguageContext extends ParserRuleContext {
		...
		public TerminalNode EOF() { return getToken(LazyLanguageParser.EOF, 0); }
		public LazylanguageContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_lazylanguage; }
	}

	public final LazylanguageContext lazylanguage() throws RecognitionException {
		LazylanguageContext _localctx = new LazylanguageContext(_ctx, getState());
		enterRule(_localctx, 0, RULE_lazylanguage);
		int _la;
		try {
	...
	public static class FunctionContext extends ParserRuleContext {
		...
		public List<TerminalNode> IDENTIFIER() { return getTokens(LazyLanguageParser.IDENTIFIER); }
		public TerminalNode IDENTIFIER(int i) {
			return getToken(LazyLanguageParser.IDENTIFIER, i);
		}
	...
	public static class ExpressionContext extends ParserRuleContext {
		public LLExpressionNode result;
	...
	public static class FactorContext extends ParserRuleContext {
		...
		public Token e;
		public TerminalNode IDENTIFIER() { return getToken(LazyLanguageParser.IDENTIFIER, 0); }
		public TerminalNode STRING_LITERAL() { return getToken(LazyLanguageParser.STRING_LITERAL, 0); }
		public TerminalNode NUMERIC_LITERAL() { return getToken(LazyLanguageParser.NUMERIC_LITERAL, 0); }
		public ExpressionContext expression() {
			return getRuleContext(ExpressionContext.class,0);
		}
		public Member_expressionContext member_expression() {
		...
		try {
			...
			case IDENTIFIER:
				...
				((FactorContext)_localctx).IDENTIFIER = match(IDENTIFIER);
				 LLExpressionNode assignmentName = factory.createStringLiteral(((FactorContext)_localctx).IDENTIFIER, false); 
				setState(183);
				_errHandler.sync(this);
	...
	public static class Member_expressionContext extends ParserRuleContext {
		public LLExpressionNode r;
		public LLExpressionNode assignmentReceiver;
		public LLExpressionNode assignmentName;
		public LLExpressionNode result;
		public ExpressionContext expression;
		public Token e;
		public Token IDENTIFIER;
		...
		public Member_expressionContext(ParserRuleContext parent, int invokingState, LLExpressionNode r, LLExpressionNode assignmentReceiver, LLExpressionNode assignmentName) {
			super(parent, invokingState);
			this.r = r;
	...
	public final Member_expressionContext member_expression(LLExpressionNode r,LLExpressionNode assignmentReceiver,LLExpressionNode assignmentName) throws RecognitionException {
