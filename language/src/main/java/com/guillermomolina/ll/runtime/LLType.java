 ...
 * for a guest program to create new instances of LLType.
 * <p>
 ...
 * <p>
 * In order to assign types to guest language values, LL values implement
...
public final class LLType implements TruffleObject {
    ...
    public static final LLType OBJECT = new LLType("Object", (l, v) -> l.hasMembers(v));
    public static final LLType FUNCTION = new LLType("Function", (l, v) -> l.isExecutable(v));
     ...
     * example, an object might be a function. In LazyLanguage we decided to make functions,
     * functions and not objects.
     */
    @CompilationFinal(dimensions = 1) public static final LLType[] PRECEDENCE = new LLType[]{NULL, NUMBER, STRING, BOOLEAN, FUNCTION, OBJECT};

    private final String name;
    private final TypeCheck isInstance;

    /*
     * We don't allow dynamic instances of LLType. Real languages might want to expose this for
     * types that are user defined.
     */
    private LLType(String name, TypeCheck isInstance) {
        this.name = name;
     ...
     * cast {@link LLType} to a constant.
     */
    ...
    /*
     * All LLTypes are declared as interop meta-objects. Other example for meta-objects are Java
    ...
    /*
     * LL does not have the notion of a qualified or lazy name, so we return the same type name
     * for both.
     */
     ...
     * LLIsInstanceBuiltin isInstance} builtin. It checks whether a given value, which might be a
     * primitive, foreign or LL value is of a given LL type. This allows other languages to make
    ...
    static class IsMetaInstance {
        ...
        static boolean doGeneric(LLType type, Object value) {
