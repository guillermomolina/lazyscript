 ...
 * SOFTWARE.
 */
package com.guillermomolina.ll.nodes.util;
...
@NodeChild
public abstract class LLUnboxNode extends LLExpressionNode {
    ...
    @Specialization
    protected static LLFunction fromFunction(LLFunction value) {
        return value;
    }

    @Specialization
    protected static LLNull fromFunction(LLNull value) {
        return value;
    }
