 ...
 * SOFTWARE.
 */
package com.guillermomolina.ll.nodes.controlflow;
...
/**
 * The loop body of a {@link LLWhileNode while loop}. A Truffle framework {@link LoopNode} between
 * the {@link LLWhileNode} and {@link LLWhileRepeatingNode} allows Truffle to perform loop
 * optimizations, for example, compile just the loop body for long running loops.
 */
public final class LLWhileRepeatingNode extends Node implements RepeatingNode {

    /**
     * The condition of the loop. This in a {@link LLExpressionNode} because we require a result
     ...
     */
    @Child private LLExpressionNode conditionNode;

    /** Statement (or {@link LLBlockNode block}) executed as long as the condition is true. */
    @Child private LLStatementNode bodyNode;
    ...
    public LLWhileRepeatingNode(LLExpressionNode conditionNode, LLStatementNode bodyNode) {
        this.conditionNode = LLUnboxNodeGen.create(conditionNode);
    ...
    public String toString() {
        return LLStatementNode.formatSourceSection(this);
    }
