...
import com.guillermomolina.ll.LLException;
...
public final class LLIfNode extends LLStatementNode {

    /**
     * The condition of the {@code if}. This in a {@link LLExpressionNode} because we require a
    ...
    /** Statement (or {@link LLBlockNode block}) executed when the condition is true. */
    @Child private LLStatementNode thenPartNode;

    /** Statement (or {@link LLBlockNode block}) executed when the condition is false. */
    @Child private LLStatementNode elsePartNode;
    ...
    public LLIfNode(LLExpressionNode conditionNode, LLStatementNode thenPartNode, LLStatementNode elsePartNode) {
