 ...
 */
public abstract class LLShortCircuitNode extends LLExpressionNode {

    @Child private LLExpressionNode left;
    @Child private LLExpressionNode right;
    ...
    public LLShortCircuitNode(LLExpressionNode left, LLExpressionNode right) {
        this.left = left;
        this.right = right;
    }
    ...
    public final boolean executeBoolean(VirtualFrame frame) {
        ...
        try {
            ...
            throw LLException.typeError(this, e.getResult(), null);
        }
        boolean rightValue;
        try {
            ...
            throw LLException.typeError(this, leftValue, e.getResult());
        }
