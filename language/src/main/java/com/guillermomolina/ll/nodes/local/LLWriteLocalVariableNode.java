 ...
 * SOFTWARE.
 */
package com.guillermomolina.ll.nodes.local;
...
import com.guillermomolina.ll.nodes.interop.NodeObjectDescriptor;
...
@NodeField(name = "nameNode", type = LLExpressionNode.class)
public abstract class LLWriteLocalVariableNode extends LLExpressionNode {
     ...
     */
    protected abstract LLExpressionNode getNameNode();
     ...
     * therefore a Truffle DLL {@link #isLongOrIllegal(VirtualFrame) custom guard} is specified.
     */
     ...
     *            Truffle DLL would not check the guard on every execution of the specialization.
    ...
    public Object getNodeObject() {
        LLExpressionNode nameNode = getNameNode();
