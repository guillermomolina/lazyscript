...
public class LLException extends RuntimeException implements TruffleException {
    ...
    @TruffleBoundary
    public LLException(String message, Node location) {
        super(message);
     ...
     */
    @TruffleBoundary
    public static LLException typeError(Node operation, Object... values) {
        ...
        if (operation != null) {
            NodeInfo nodeInfo = LLContext.lookupNodeInfo(operation.getClass());
            if (nodeInfo != null) {
        ...
        return new LLException(result.toString(), operation);
    }
