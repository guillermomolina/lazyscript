...
public class LLSeparatedClassLoadersTest {
    ...
    @Test
    public void sdkAndTruffleLanguageAPIAndLLInSeparateClassLoaders() throws Exception {
        ...
        URL llURL = LazyLanguage.class.getProtectionDomain().getCodeSource().getLocation();
        ...
        URLClassLoader slLoader = new URLClassLoader(new URL[]{llURL}, truffleLoader);
