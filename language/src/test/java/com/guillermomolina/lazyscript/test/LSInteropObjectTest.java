...
public class LSInteropObjectTest {
    ...
    public void testObject() {
        final Source src = Source.newBuilder("ls", "function main() {o = new(); o.a = 10; o.b = \"B\"; return o;}", "testObject.ls").buildLiteral();
    ...
    public void testNewForeign() {
        final Source src = Source.newBuilder("ls", "function getValue(type) {o = new(type); o.a = 10; return o.value;}", "testObject.ls").buildLiteral();
        context.eval(src);
        Value getValue = context.getBindings("ls").getMember("getValue");
