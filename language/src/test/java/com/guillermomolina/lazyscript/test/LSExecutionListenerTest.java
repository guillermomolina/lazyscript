...
public class LSExecutionListenerTest {
    ...
    public void testFactorial() {
        ...
        String characters =
                        ...
                        "}";
        // @formatter:on
        context.eval("ls", "function " + characters);
        Value factorial = context.getBindings("ls").getMember("fac");
    ...
    private Value eval(String s) {
        ...
        context.eval("ls", wrapInFunction(s));
        return context.getBindings("ls").getMember("wrapper").execute();
    }
