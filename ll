...
MAIN_CLASS="com.guillermomolina.ll.launcher.LLMain"
...
if [[ "$GRAALVM_VERSION" != "" ]]; then
    ...
    LAUNCHER_PATH="$SCRIPT_HOME/../jre/languages/ll/launcher/ll-launcher.jar:$SCRIPT_HOME/../languages/ll/launcher/ll-launcher.jar"
    JAVACMD="$SCRIPT_HOME/java"
    versionCheck "Installed in wrong version of GraalVM. Expected: $VERSION, found $GRAALVM_VERSION"
else
    LANGUAGE_PATH="$SCRIPT_HOME/language/target/lazylanguage.jar"
